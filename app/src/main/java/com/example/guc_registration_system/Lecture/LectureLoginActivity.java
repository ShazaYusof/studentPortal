...
public class LectureLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            finish();
            startActivity(new Intent(LectureLoginActivity.this, LectureHomepageActivity.class));
        }
        ...
        firebaseAuth.signInWithEmailAndPassword(userName,userPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(LectureLoginActivity.this,"Login Failed!!",Toast.LENGTH_SHORT).show();
                    counter--;
